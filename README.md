...
# skip the googletest
# dont use system protobuf always use the compiled bin to avoid mismatch and compilation error
cmake -GNinja -Dprotobuf_BUILD_TESTS=OFF -Dprotobuf_BUILD_PROTOC_BINARIES=ON ..
